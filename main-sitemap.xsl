			...
			<head>
				<xsl:choose>
					<xsl:when test="kml:kml">
						<title>Locations Sitemap - Political Practices in Exile</title>
					</xsl:when>
					<xsl:otherwise>
						<title>XML Sitemap - Political Practices in Exile</title>
					</xsl:otherwise>
				</xsl:choose>
				...
				<xsl:choose>
					<xsl:when test="kml:kml">
						...
						<div id="content">
							...
							<p class="expl">
								<a href="http://political-practices-in-exile.test/?sitemap=1">&#8592; Sitemap Index</a>							</p>
